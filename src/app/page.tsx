...
export default function Home() {
  return (
    <div className="flex flex-col items-center w-full bg-brand-off-white text-brand-black">
      ...
      <section className="w-full py-32 md:py-48 px-6 md:px-16 flex justify-center items-center">
      ...
      <section className="w-full py-24 md:py-32 px-6 md:px-16 bg-brand-light-gray/30">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16 md:gap-24">
          <div className="w-full md:w-7/12 relative h-[500px] md:h-[700px] flex items-center justify-center">
            {/* Base Image */}
            <div className="absolute top-0 left-0 w-[80%] h-[400px] md:h-[550px] z-10">
              <Image 
            ...
            {/* Overlapping Image */}
            <div className="absolute bottom-0 right-0 w-[65%] h-[300px] md:h-[450px] shadow-2xl z-20 border-[8px] border-brand-off-white transform translate-y-8 md:translate-y-16 -translate-x-4">
              <Image 
          ...
          <div className="w-full md:w-5/12 text-left pt-16 md:pt-0">
            <h3 className="text-xs font-semibold uppercase tracking-[0.3em] mb-6 text-brand-gray">Featured Story</h3>
            ...
            <Link href="/about" className="inline-block text-xs uppercase tracking-[0.2em] font-semibold border-b border-brand-black pb-2 hover:text-brand-gray hover:border-brand-gray transition-all">
      ...
      <section className="w-full py-32 md:py-48 px-6 md:px-16 bg-brand-off-white">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-20 md:mb-32 gap-8">
            <h2 className="font-serif text-[clamp(3rem,6vw,4.5rem)] font-light text-brand-charcoal text-balance leading-none m-0">Curated Services</h2>
            <Link href="/services" className="hidden md:inline-block text-xs uppercase tracking-[0.2em] font-semibold border-b border-brand-black pb-1 hover:text-brand-gray transition-all">
              View All Services
            </Link>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-32">
            {[
              ...
              <Link href={s.link} key={s.name} className={`group flex flex-col ${s.offset ? 'md:mt-32' : ''}`}>
                <div className="w-full relative aspect-[3/4] mb-8 overflow-hidden bg-brand-light-gray">
                  <Image src={s.img} alt={s.name} fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover group-hover:scale-105 transition-transform duration-[1.5s] ease-out" />
                </div>
          ...
          <div className="text-center mt-20 md:hidden">
            <Link href="/services" className="inline-block text-xs uppercase tracking-[0.2em] font-semibold border-b border-brand-black pb-1 hover:text-brand-gray transition-all">
              View All Services
            </Link>
          </div>
        </div>
      ...
      <section className="w-full py-32 md:py-48 px-6 md:px-16 bg-brand-black text-brand-off-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="relative w-full aspect-[4/3] md:aspect-[2/1] bg-brand-charcoal overflow-hidden group">
            <Image src="/images/_shilpa_santhosh_1787399276_3969314718661171190_9666622877.jpg" alt="Dark Cinematic" fill sizes="100vw" className="object-cover opacity-80 group-hover:opacity-100 transition-opacity duration-1000" />
          </div>
        </div>
      </section>
    </div>
